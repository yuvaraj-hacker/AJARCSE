    ...
    <>
      ...
      <section className="  ">
              ...
              <div className="max-w-[80rem] mx-auto px-5 relative z-10">
                <div className="grid md:grid-cols-2">
                  <div className="text-white my-10 space-y-5">
                    ...
                    <div className="bg-[#388883] p-3 w-fit rounded-3xl border-white border-2 text-sm cursor-pointer animate-glow">
                      Publish With Us
                    </div>
                  </div>
                </div>
              ...
              <div className="max-w-[80rem] mx-auto px-5 md:pt-10 pt-5 md:pb-16 pb-5">
                <div className="grid md:grid-cols-2 md:gap-5 gap-5 items-center">
                  ...
                  <div className="text-black ">
                    <p className="text-justify">Welcome to <span className="md:text-xl text-sm"> American Journal of Advanced Research in Computer Science & Engineering (AJARCSE)</span> is a scholarly online,
        ...
        <section className="md:my-10  my-5 ">
          <p className="text-center md:text-2xl text-lg">Research Areas Covered</p>
